      ...
      <div className="mt-10">
        {loading ? (
          ...
          <>
            ...
            <div className="grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3">{searchText ? <RenderCards data={searchedResults} title="No search result found" /> : <RenderCards data={allPosts} title="No posts found" />}</div>
          </>
        )}
      </div>
    </section>
